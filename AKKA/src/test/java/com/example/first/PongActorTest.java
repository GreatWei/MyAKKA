...
public class PongActorTest {
    ...
    public void myTest() throws Exception {
        CompletionStage<String> cf = askPong("Ping").thenCompose(x -> askPong("Ping" + x)).handle((x, t) -> {
            if (t != null) {
                return "default";
            } else {
                return x;
     ...
     //   System.out.println(get(cf));
        CompletionStage<String> cf1 = askPong("Ping").thenCombine(askPong("Pong"), (a, b) -> {
            return a + b;
        });
        System.out.println(get(cf1));
